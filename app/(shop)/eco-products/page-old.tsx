...
// A simple React component that displays eco friendly Amazon products grouped by category.
// Each product card includes a name, a brief description, a note on materials and why it's
// safer, and an affiliate link with the proper `rel="sponsored nofollow"` attribute.
...
// Products categorized into Personal Care, Kitchen, and Laundry. Each URL includes
// the appropriate Amazon affiliate tag provided by the user.
    ...
    items: [
      {
        ...
        notes:
          "Plant‑based bristles and bamboo handle; plastic‑free packaging; no SLS or BPA.",
      },
      {
        ...
        notes:
          "Silk floss with candelilla wax; refillable glass dispenser; compostable and plastic‑free.",
      },
      {
        ...
        notes:
          "Stainless steel razor replaces disposable plastic cartridges; fully recyclable; zero plastic waste.",
      },
      {
        ...
        notes:
          "Salon‑quality shampoo bar with no sulfates or parabens; packaged in compostable paper; no plastic bottle.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        notes:
          "Organic cotton infused with beeswax, tree resin & jojoba oil; replaces plastic wrap; compostable.",
      },
      {
        ...
        notes:
          "Made from cellulose & cotton; machine‑washable and compostable; replaces paper towels.",
      },
      {
        ...
        notes:
          "Durable 18/8 stainless steel; BPA‑free; comes with cleaning brushes; eliminates single‑use plastic straws.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        notes:
          "Made from 100% New Zealand wool; replaces disposable dryer sheets; no synthetic fragrances or fillers.",
      },
    ],
  },
];
            ...
            {section.items.map((item) => (
              ...
              >
                ...
                <div className="mt-4">
                  ...
                  >
                    <button
                      className="px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium shadow-sm"
                    >
                      Buy on Amazon
                    </button>
                  </a>
